...
class TestStatsServiceIntegration:
    ...
    def test_service_with_large_datasets(self):
        ...
        for i in [0, 25, 50, 99]:
            ...
            actual = next(stat for stat in result if stat.event_type == expected["event_type"])
    ...
    def test_mixed_success_and_failure_scenarios(self):
        ...
        self.mock_redis.get_event_stats.side_effect = Exception("Individual query failed")
