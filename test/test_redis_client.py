...
class TestRedisClient:
    ...
    def test_ping_connection_error(self):
        ...
        self.redis_client.redis = Mock()
        self.redis_client.redis.ping.side_effect = redis.ConnectionError("Connection failed")
    ...
    def test_get_event_stats_existing_event(self):
        ...
        # Verify pipeline operations
        mock_pipeline.get.assert_any_call(REDIS_COUNT_KEY.format(event_type="user_signup"))
        mock_pipeline.get.assert_any_call(REDIS_SUM_KEY.format(event_type="user_signup"))
        mock_pipeline.execute.assert_called_once()
    ...
    def test_get_all_event_types_with_data(self):
        ...
        self.redis_client.redis = Mock()
        self.redis_client.redis.smembers.return_value = {"user_signup", "user_login", "page_view"}
    ...
    def test_redis_connection_error_handling(self):
        ...
        self.redis_client.redis = Mock()
        self.redis_client.redis.pipeline.side_effect = redis.ConnectionError("Connection failed")
