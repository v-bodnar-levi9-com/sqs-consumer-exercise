...
class TestMessageProcessor:
    ...
    @pytest.mark.asyncio
    async def test_message_processor_success(
        self, mock_sqs_config, mock_print_stats, mock_process_messages
    ):
    ...
    async def test_message_processor_error_handling(
        self, mock_sqs_config, mock_logger, mock_process_messages
    ):
...
class TestProcessMessagesIntegration:
    ...
    def test_process_messages_called_correctly(
        self, mock_process_func, mock_event_loop
    ):
