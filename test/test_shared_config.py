...
class TestConfig:
    ...
    @patch.dict(os.environ, {
        'SQS_QUEUE_NAME': 'custom-queue-name'
    })
    ...
    def test_missing_environment_variables(self):
        ...
        env_vars_to_clear = [
            ...
            'SQS_QUEUE_NAME', 'REDIS_HOST', 'REDIS_PORT', 'REDIS_DB',
            'MAX_MESSAGES_PER_BATCH', 'SQS_WAIT_TIME_SECONDS', 'PROCESSOR_SLEEP_INTERVAL',
