...
class TestProcessMessages:
    ...
    def test_process_messages_no_messages(self, mock_client):
        ...
        mock_client.receive_message.assert_called_once_with(
            QueueUrl=self.test_queue_url, MaxNumberOfMessages=10, WaitTimeSeconds=20
        )
    ...
    def test_process_messages_valid_single_message(self, mock_client):
        ...
        mock_client.delete_message.assert_called_once_with(
            QueueUrl=self.test_queue_url, ReceiptHandle="test-receipt-handle-1"
        )
    ...
    def test_process_messages_invalid_schema(self, mock_logger, mock_client):
        ...
        messages = [
            {
                "Body": json.dumps({"type": "user_signup"}),
                "ReceiptHandle": "handle1",
            },  # missing value
            {
    ...
    def test_process_messages_accumulation(self, mock_client):
        ...
        messages_batch1 = [
            ...
            {
                "Body": json.dumps({"type": "click", "value": 2.5}),
                "ReceiptHandle": "handle2",
            },
        ]
        ...
        messages_batch2 = [
            {
                "Body": json.dumps({"type": "page_view", "value": 3}),
                "ReceiptHandle": "handle3",
            },
            {
                "Body": json.dumps({"type": "page_view", "value": 2}),
                "ReceiptHandle": "handle4",
            },
            {
                "Body": json.dumps({"type": "click", "value": 1.5}),
